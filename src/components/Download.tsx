...
const Download = () => {
  return (
    <section className='w-full min-h-screen md:min-h-fit lg:min-h-screen w-full flex justify-center bg-white px-6 md:px-0 md:py-12 lg:py-24'>
        <div className='w-full md:h-[500px] max-w-[1400px] flex md:px-12 lg:px-24'>
            <div className='size-full rounded-2xl overflow-hidden relative bg-secondarygray p-6 md:p-12 pb-0 flex flex-col md:flex-row justify-between'>
                ...
                <div className='z-20 relative md:h-full mt-6 md:mt-0 flex flex-col justify-end'>
