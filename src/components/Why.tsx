...
const Why = () => {
  return (
    <section className='w-full min-h-screen md:min-h-fit lg:min-h-screen w-full flex items-center justify-center bg-secondarygray px-6 md:px-0 py-24'>
        <div className='w-full h-[500px] max-w-[1400px] flex md:px-24 items-center justify-center'>
            <div className='size-full rounded-2xl overflow-hidden relative px-6 md:px-12 lg:px-0'>
